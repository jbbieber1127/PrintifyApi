...
public class PrintifyApiClient : HttpClient, IPrintifyApiClient
{
    /// <summary>
    /// A constructor that adds rate limiting
    /// </summary>
    public PrintifyApiClient(string baseUrl, string apiKey, int maxRequestsRate, TimeSpan ratePeriod) : base(new ClientSideRateLimitedHandler(new TokenBucketRateLimiter(new TokenBucketRateLimiterOptions()
    {
